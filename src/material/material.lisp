...
(defmethod print-object ((obj material) stream)
  (print-unreadable-object (obj stream :type T :identity T)
    (with-slots (specular metallic emissive roughness fakeambient idx) obj
      (format stream "IDX:~a R:~a E:~a M:~a S:~a FAO:~a"
              idx roughness emissive metallic specular fakeambient))))
...
(defmethod upload ((obj material))
  (with-slots (ubo idx specular metallic emissive roughness fakeambient)
      obj
